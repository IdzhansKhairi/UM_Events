...
public class CalendarAddEventActivity extends AppCompatActivity implements CalendarAdapter.OnItemListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.add_event_calendar_view);
        initWidgets();
        setWeekView();
    }
